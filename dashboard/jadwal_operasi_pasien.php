...
<script>
    // ubah page title
    $(document).prop('title', 'Jadwal Operasi Pasien')
</script>

<main id="main" class="main">

    <section class="pagetitle">
        <h1>Jadwal Operasi Pasien</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
                <li class="breadcrumb-item active">Jadwal Operasi Pasien</li>
            </ol>
        </nav>
    ...
    <section class="section">
        <div class="row">
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Tabel Jadwal Operasi Pasien</h5>
